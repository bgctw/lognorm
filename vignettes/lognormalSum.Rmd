---
title: Approximating the sum of lognormal random variables
output: 
...
For a test on correlated variables see the 
[aggregateCorrelated vignette](aggregateCorrelated.html).
